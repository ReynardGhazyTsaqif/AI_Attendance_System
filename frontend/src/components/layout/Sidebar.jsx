  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        <path d="M8.5 17.5c1 .3 2.3.5 3.5.5s2.5-.2 3.5-.5" />
      ...
      <div className="px-3  border-b border-gray-100">
        <div className="relative">
          <img
            src="/LogoTitle.png"
            alt="PresenAI"
            className="w-[75%] h-auto object-contain mr-auto"
          />

          {onClose && (
            <button
              onClick={onClose}
              className="absolute right-0 top-0 lg:hidden p-1 rounded bg-white/80 text-gray-400 hover:text-gray-600"
            >
              <svg
                width="16"
                height="16"
